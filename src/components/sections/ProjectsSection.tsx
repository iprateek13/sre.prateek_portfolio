          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
              ...
              <div className="lg:col-span-5 p-6 rounded-2xl bg-dark-950 border border-slate-800 space-y-4">
                <div className="flex flex-wrap items-center justify-between gap-2 pb-3 border-b border-slate-800 text-xs font-mono text-slate-400 overflow-hidden">
                  <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 text-slate-300 min-w-0">
                      <Terminal className="w-3.5 h-3.5 text-azure-400 shrink-0" />
                      <span className="truncate text-[11px] sm:text-xs">azure_landing_zone.tf</span>
                    </div>
                  </div>
                  <span className="text-emerald-400 px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-[10px] font-bold shrink-0">✓ Validated</span>
                </div>
