    ...
    <section id="skills" className="py-20 sm:py-32 relative overflow-hidden bg-mesh-gradient">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-10 flex flex-col md:flex-row items-center justify-between gap-4 p-4 rounded-3xl bg-white/80 dark:bg-dark-900/80 border border-slate-200/80 dark:border-slate-800 backdrop-blur-xl shadow-xl">
          {/* Category Pills */}
          <div className="flex items-center gap-2 w-full md:w-auto overflow-x-auto no-scrollbar pb-1 md:pb-0 md:flex-wrap">
            {categories.map((cat) => (
              <button
                key={cat}
                onClick={() => setSelectedCategory(cat)}
                className={`px-3.5 py-2 rounded-2xl text-xs font-heading font-semibold transition-all duration-300 whitespace-nowrap shrink-0 ${
