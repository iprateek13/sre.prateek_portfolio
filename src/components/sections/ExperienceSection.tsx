...
import { MapPin, CheckCircle2, Sparkles, Building2, Activity, ShieldCheck } from "lucide-react";
                  ...
                  <div className="w-full sm:w-1/2 pl-12 sm:pl-0 sm:px-8">
                    <div className="p-6 sm:p-7 rounded-3xl bg-white/90 dark:bg-dark-900/90 border border-slate-200/80 dark:border-slate-800/80 backdrop-blur-xl hover:border-azure-500/50 dark:hover:border-cyan-400/50 transition-all duration-300 shadow-lg group">
                      <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
                        ...
                        {exp.isCurrent && (
                          <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-extrabold bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 uppercase flex items-center gap-1">
                      ...
                      {/* SRE Reliability Badge Bar */}
                      <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-dark-950/60 border border-slate-200 dark:border-slate-800 mb-4 flex items-center justify-between text-[11px] font-mono">
                        <span className="flex items-center gap-1 text-azure-600 dark:text-cyan-400 font-bold">
                          <ShieldCheck className="w-3.5 h-3.5 text-emerald-500" />
                          <span>Reliability Scope</span>
                        </span>
                        <span className="text-emerald-600 dark:text-emerald-400 font-bold">99.99% Uptime Target</span>
                      </div>
